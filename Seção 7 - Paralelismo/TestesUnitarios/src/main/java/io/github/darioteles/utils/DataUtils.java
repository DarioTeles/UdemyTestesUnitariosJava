package io.github.darioteles.utils;
...
/**
 * Define um utilizatário para tratativas de datas.
 */
public class DataUtils {

	/**
	 * Retorna a data enviada por parametro com a adicao dos dias desejado a Data
	...
	/**
	 * Retorna uma instancia de <code>Date</code> refletindo os valores passados por
	 * parametro
	 * 
	 * @param dia
	 * @param mes
	...
	/**
	 * Verifica se uma data e igual a outra Esta comparacao considera apenas dia,
	 * mes e ano
	 * 
	 * @param data1
	 * @param data2
